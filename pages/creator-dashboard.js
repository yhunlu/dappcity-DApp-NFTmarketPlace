...
const CreatorDashboard = () => {
  ...
  return (
    <div className="justify-center">
      <div className="p-4">
        {nfts.length > 0 && (<h2 className="text-2xl py-2 font-bold bg-purple-100 text-center shadow-xl text-purple-900">Items Created</h2>)}
      ...
      <div className="px-4">
        {Boolean(sold.length) && (
          <div>
            <h2 className="text-2xl py-2 font-bold bg-purple-100 text-center shadow-xl text-purple-900">Items Sold</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
              {sold.map((nft, i) => (
                <div
                  key={i}
